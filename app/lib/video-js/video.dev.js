/**
 * Customized to emit certain events when things are clicked
 */
(function() {
/**
...
vjs.PlayToggle.prototype.onClick = function(){
  if (this.player_.paused()) {
    ...
    this.player_.pause();
    this.player_.trigger('pauseButtonClicked');
  }
};
...
vjs.FullscreenToggle.prototype.onClick = function(){
  if (!this.player_.isFullscreen()) {
    ...
    this.player_.trigger('fullscreenClick');
  } else {
    this.player_.exitFullscreen();
    this.controlText_.innerHTML = 'Fullscreen';
    this.player_.trigger('windowedClick');
  }
};
/**
...
vjs.SeekBar.prototype.onMouseDown = function(event){
  ...
  this.player_.pause();
  this.player_.trigger('scrubStart');
};
...
vjs.MuteToggle.prototype.onClick = function(){
  var doMute = this.player_.muted() ? false : true;
  this.player_.muted(doMute);
  this.player_.trigger(doMute ? 'muteClick' : 'unMuteClick');
};
...
vjs.PlaybackRateMenuItem.prototype.onClick = function(){
  ...
  this.player_.trigger('playbackRateClick');
};
