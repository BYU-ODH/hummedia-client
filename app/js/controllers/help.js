function HelpCtrl($scope, $routeParams, $location) {
    ...
    $scope.titles = ['About', 'Annotation Types', 'Adding Annotations', 'Adding Content to Your Collection', 'Adding Subtitles', 'Creating a Collection', 'Linking Content Via YouTube', 'Using Cliplists', 'Viewing Subtitles', "Students can't see my course!", 'Extra Help']
