...
/*
function AdminStaleVideoCtrl($scope, Video, language, $routeParams, $location, Collection, Subtitle) {
    "use strict";
...
AdminStaleVideoCtrl.$inject = ['$scope','Video', 'language', '$routeParams', '$location', 'Collection', 'Subtitle'];
*/
