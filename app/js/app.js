...
angular.module('hummedia', ['hummedia.config','hummedia.filters', 'hummedia.services', 'hummedia.directives', 'ngLocale', 'ngSanitize', 'ngRoute']).
  config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/admin/video/stale', {title: "Hummedia | Stale Media", admin: true, templateUrl: '/partials/admin-stale.html', controller: TestController, reloadOnSearch: false});
